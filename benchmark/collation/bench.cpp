...
NamedTimes collation_stages(const ton::validator::CollationStats& stats) {
  ...
  return {{"total", w.total},
          ...
          {"new_messages", w.new_messages},
          {"new_messages_route", w.new_messages_route},
          {"new_messages_prepare", w.new_messages_prepare},
          {"new_messages_execute", w.new_messages_execute},
          {"new_messages_commit", w.new_messages_commit},
          {"prelim_storage_stat", w.prelim_storage_stat},
          {"trx_tvm", w.trx_tvm},
          {"trx_storage_stat", w.trx_storage_stat},
          {"trx_other", w.trx_other},
          {"trx_unpack", w.trx_unpack},
          {"trx_storage_credit", w.trx_storage_credit},
          {"trx_compute", w.trx_compute},
          {"trx_action_bounce", w.trx_action_bounce},
          {"trx_serialize", w.trx_serialize},
          {"msg_parse", w.msg_parse},
          {"account_lookup", w.account_lookup},
          {"account_dict_lookup", w.account_dict_lookup},
          {"account_unpack", w.account_unpack},
          {"trx_limits", w.trx_limits},
          {"trx_commit", w.trx_commit},
          {"trx_postprocess", w.trx_postprocess},
          {"message_descriptor", w.message_descriptor},
          {"account_dict_estimator_update", w.account_dict_estimator_update},
          {"account_dict_estimator_proof", w.account_dict_estimator_proof},
          {"account_block_build", w.account_block_build},
          {"final_account_dict_update", w.final_account_dict_update},
          {"final_account_dict_async_work", w.final_account_dict_async_work},
          {"final_account_dict_async_wait", w.final_account_dict_async_wait},
          {"final_account_dict_rebind", w.final_account_dict_rebind},
          {"account_storage_dict", w.account_storage_dict},
          ...
          {"state_build_root", w.state_build_root},
          {"state_merkle_update", w.state_merkle_update},
          {"state_limit_proof", w.state_limit_proof},
          {"create_block", w.create_block},
          {"create_collated_data", w.create_collated_data},
          {"collated_prepare_proofs", w.collated_prepare_proofs},
          {"collated_state_proof", w.collated_state_proof},
          {"collated_neighbor_proofs", w.collated_neighbor_proofs},
          {"collated_storage_proofs", w.collated_storage_proofs},
          {"candidate_block_boc", w.candidate_block_boc},
          {"candidate_collated_boc", w.candidate_collated_boc},
          {"candidate_hashes", w.candidate_hashes},
          {"candidate_construct", w.candidate_construct},

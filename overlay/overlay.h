...
class Overlay : public td::actor::Actor {
 public:
  ...
  virtual void send_broadcast_fec(PublicKeyHash send_as, td::uint32 flags, BroadcastFecDissemination dissemination,
                                  td::BufferSlice data, td::BufferSlice extra) = 0;

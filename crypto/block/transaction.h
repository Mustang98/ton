...
struct Transaction {
  ...
  // Exact operation cost of the successful generated Transaction TLB check.
  // Collator may reuse this only after commit() installs this immutable root.
  int generated_tlb_validation_ops{0};

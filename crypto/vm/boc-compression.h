...
td::Result<td::BufferSlice> boc_compress_improved_structure_lz4(const std::vector<td::Ref<vm::Cell>>& boc_roots, bool compress_merkle_update = false, td::Ref<vm::Cell> state = td::Ref<vm::Cell>());
